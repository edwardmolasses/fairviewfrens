...
export default function Home() {
    return (
        <div className="min-h-screen h-full w-full flex flex-col overflow-hidden">
            ...
            <header className="min-w-full text-gray-800 py-5 md:py-8 lg:py-20 px-4 md:px-10">
                <div className="flex items-center container mx-auto max-w-5xl justify-between h-full text-blue-50">
                    {/* Logo */}
                    <a href="#">
                        <a className="font-coiny text-xl md:text-5xl font-bold block sm:hidden">
                            <span className='rainbow-text-1 text-outline'>F</span>
                            <span className='rainbow-text-2 text-outline'>a</span>
                            <span className='rainbow-text-3 text-outline'>i</span>
                            <span className='rainbow-text-4 text-outline'>r</span>
                            <span className='rainbow-text-5 text-outline'>v</span>
                            <span className='rainbow-text-6 text-outline'>i</span>
                            <span className='rainbow-text-1 text-outline'>e</span>
                            <span className='rainbow-text-2 text-outline'>w</span> Frens
                        </a>
                        <a className="font-coiny text-xl md:text-5xl font-bold hidden sm:block">
                            <span className='rainbow-text-1 text-outline-2x'>F</span>
                            <span className='rainbow-text-2 text-outline-2x'>a</span>
                            <span className='rainbow-text-3 text-outline-2x'>i</span>
                            <span className='rainbow-text-4 text-outline-2x'>r</span>
                            <span className='rainbow-text-5 text-outline-2x'>v</span>
                            <span className='rainbow-text-6 text-outline-2x'>i</span>
                            <span className='rainbow-text-1 text-outline-2x'>e</span>
                            <span className='rainbow-text-2 text-outline-2x'>w</span> Frens
                        </a>
                    </a>

                    {/* Opensea Twitter Discord Links */}
                    <nav aria-label="Contact Menu">
                        <ul className="flex items-center space-x-4 md:space-x-6 mr-2">
                            <li className="cursor-pointer">
                                <a href="https://opensea.io" target="_blank" rel="noreferrer">
                                    <svg
                                        className="w-6 h-6 md:w-12 md:h-12 transition ease-in-out delay-30 opensea-btn"
                                        viewBox="0 0 90 90"
                                        fill="none"
                            ...
                            <li className="cursor-pointer">
                                <a
                                    href="https://twitter.com/FairviewFrens"
                                    target="_blank"
                                    rel="noreferrer"
                                >
                                    <svg
                                        className="w-6 h-6 md:w-12 md:h-12 transition ease-in-out delay-30 twitter-btn"
                                        stroke="currentColor"
                                        fill="currentColor"
                                        strokeWidth="0"
                                        viewBox="0 0 512 512"
